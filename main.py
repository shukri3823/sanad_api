...
class User(BaseModel):
 ...
 username: str
 email: str
 password: str # للتجربة فقط، لا تستخدمه مكشوفًا في مشروع حقيقي

# "قاعدة بيانات" مؤقتة في الذاكرة للتجربة
users_db: List[User] = []


@app.get("/")
def read_root():
 return {"message": "Sanad API is working with users!"}
